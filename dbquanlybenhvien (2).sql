...
-- Thời gian đã tạo: Th9 07, 2020 lúc 04:22 AM
...
INSERT INTO `chitietbenhnhan` (`id_chitietbenhnhan`, `tenbenhnhan`, `gioitinh`, `ngaysinh`, `diachi`, `ngaynhapvien`, `id_phong`, `id_khoa`, `img_benhnhan`) VALUES
(1, 'Nguyễn Văn Khải', 'Nam', '27/01/2000', 'Gò vấp', '22/08/2020', 1, 1, 'benhnhan1.jpg'),
(2, 'Trần Quốc Bảo', 'Nam', '22/02/2000', 'Thủ Đức', '24/08/2020', 1, 2, 'benhnhan2.jpg');
...
(1, 'Thuốc cảm', '20.000', '0', 'Việt Nam', 'thuoc1.jpg'),
(2, 'Thuốc ho', '30.000', '0', 'Mỹ', 'thuoc2.jpg');
...
CREATE TABLE IF NOT EXISTS `tinnhan` (
  `id_tinnhan` int(11) NOT NULL AUTO_INCREMENT,
